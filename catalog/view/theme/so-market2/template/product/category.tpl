...
/*VARIABLES*/	
	...
	$new_text =  (isset($soconfig_pages[$lang]["new_text"]) && !empty($soconfig_pages[$lang]["new_text"]) ? $soconfig_pages[$lang]["new_text"] : 'NEW');
	$sale_text = (isset($soconfig_pages[$lang]["sale_text"]) && !empty($soconfig_pages[$lang]["sale_text"]) ? $soconfig_pages[$lang]["sale_text"] : 'SALE');
	$quick_view_text = isset($soconfig_pages[$lang]["quick_view_text"]) && !empty($soconfig_pages[$lang]["quick_view_text"]) ? $soconfig_pages[$lang]["quick_view_text"] : 'QuickView' ;
				...
				<div class="left-block">
					...
					<?php if (!isset($quick_status) || $quick_status != 0) : ?>
						<!--full quick view block-->
							...
							<a class="quickview iframe-link visible-lg" data-fancybox-type="iframe"  href="<?php echo $our_url->link('product/quickview','product_id='.$product['product_id']);?>">  <?php echo  $quick_view_text  ?></a>
