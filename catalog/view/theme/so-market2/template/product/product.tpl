        ...
        <div class="product-view row">
		  <div class="left-content-product <?php echo (!empty($column_right)  || isset($html_product_right) && $html_product_right != '' && $html_product_right != '<p>&nbsp;</p>' ? 'col-lg-10 col-xs-12' : 'col-xs-12'); ?>">
			...
			<?php //Img Gallery Block -------?>
                ...
                <div class="content-product-left  <?php if(isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left'){echo "col-sm-7 col-xs-12"; }else { echo "col-sm-6 col-xs-12"; } ?> ">
                    ...
                    <?php if ($images && (isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left')) : ?>
                        <div id="thumb-slider" class="thumb-vertical-outer col-xs-3">
							<span class="view_scroll_spacer"><a class="prev"  href="#"><i class="fa fa-angle-left"></i></a></span>
							<div class="thumb-vertical">
									<ul class="previews-list ">
										...
										<li><a class="thumb-video thumbnail" href="<?php echo $video1; ?>"><img alt="youtube video"  class="fancybox-video" src = "catalog/view/theme/<?php echo $config->get('config_template'); ?>/images/video.png" ></a></li>
										<?php endif; ?>
									</ul>
							</div>
							 <span class="view_scroll_spacer"><a class="next" href="#"><i class="fa fa-angle-right"></i></a></span>
                    ...
                    <?php if ($images  && (isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'bottom')) : ?>
                        <div id="thumb-slider" class="owl-theme owl-loaded owl-drag <?php echo ((count($images) < 3 && (!isset($video1) || $video1 == '') || (count($images) == 1)) ? 'not_full_slider' : 'full_slider'); ?> <?php echo (isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left' ? 'flexslider-large visible-xs' : 'owl-carousel'); ?>">
							...
							<?php if (isset($video1) && $video1 != '') : ?>
								<a class="thumb-video thumbnail" href="<?php echo $video1; ?>"><img alt="youtube video"  class="fancybox-video" src = "catalog/view/theme/<?php echo $config->get('config_template'); ?>/images/video.png" ></a>
							<?php endif; ?>
                        </div>
			...
			<div class="content-product-right <?php if(isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left'){echo "col-sm-5 col-xs-12"; }else { echo "col-sm-6 col-xs-12"; } ?>">
