	...
	<div id="sp-cpanel_settings">
		<div class="panel-group">
			...
			<div class="group-schemes" >
				<span data-scheme="default"  class="item_scheme <?php echo (isset($soconfig_general["themecolor"]) && $soconfig_general["themecolor"]=="default") ? 'selected' : ''?>"><span style="background: #e8622d;"></span></span>
