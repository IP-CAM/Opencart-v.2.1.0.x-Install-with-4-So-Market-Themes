        ...
        <div class="extraslider-inner" data-effect="<?php echo $effect; ?>">
            ...
            ?>
				...
				<div class="product-item-inner">
				    ...
				    <div class="image">
						  <a href="<?php echo $product['href']; ?>" target="<?php echo $item_link_target;?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo html_entity_decode($product['name']); ?>" class="img-responsive" /></a>
				    </div>
				    <?php } ?>
				    <div class="item-time">
